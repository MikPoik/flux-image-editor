  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 container mx-auto px-4 py-8">
        <section className="text-center max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 border border-slate-300/50 dark:border-slate-700/50 rounded-2xl p-6 hover:border-blue-400/50 dark:hover:border-blue-400/50 hover:shadow-xl hover:shadow-blue-500/10 dark:hover:shadow-blue-500/10 transition-all duration-300">
              ...
              <div>
                ...
                <Link href="/image-editor">
                  <Button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 dark:from-blue-500 dark:to-purple-600 dark:hover:from-blue-600 dark:hover:to-purple-700">
                    Start Editing
                  </Button>
                </Link>
              </div>
            ...
            <div className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 border border-slate-300/50 dark:border-slate-700/50 rounded-2xl p-6 hover:border-purple-400/50 dark:hover:border-purple-400/50 hover:shadow-xl hover:shadow-purple-500/10 dark:hover:shadow-purple-500/10 transition-all duration-300">
              ...
              <div>
                ...
                <Link href="/gallery">
                  <Button className="w-full border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white">
                    Open Gallery
                  </Button>
                </Link>
              </div>
          ...
          {/* Feature Highlights */}
          <div className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 rounded-2xl p-6 border border-slate-300/50 dark:border-slate-700/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 bg-slate-200/30 dark:bg-slate-700/30 border border-slate-300/50 dark:border-slate-600/50 rounded-lg">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">Designed for seamless editing on any device</p>
              </div>
            </div>
          </div>
        </section>
