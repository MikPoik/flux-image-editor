  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        {/* CTA Section */}
        <div className="text-center mt-16 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 border border-slate-300 dark:border-slate-700/50 rounded-2xl p-12">
