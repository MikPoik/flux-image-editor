  ...
  const plans = [
    {
      ...
      period: "/month",
      credits: 120,
      features: ["120 credits per month", "Editing/Generation: 1 credit each", "Upscales: Free", "Kontext Pro AI model"],
    ...
    },
    {
      ...
      period: "/month",
      credits: 200,
      features: ["200 credits per month", "Editing/Generation: 1 credit each", "Upscales: Free", "Kontext Max AI model (highest quality)"],
    ...
    },
    {
      ...
      period: "/month",
      credits: 300,
      features: ["300 credits per month", "Editing/Generation: 1 credit each", "Upscales: Free", "Kontext Max AI model (highest quality)"],
