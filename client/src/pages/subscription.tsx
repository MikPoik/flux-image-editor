  ...
  const plans = [
    {
      ...
      period: "/month",
      credits: 240,
      features: ["240 credits per month", "All operations: 4 credits", "Upscale: 1 credit", "Kontext Pro AI model"],
    ...
    },
    {
      ...
      period: "/month",
      credits: 400,
      features: ["400 credits per month", "All operations: 4 credits", "Upscale: 1 credit", "Kontext Max AI model (highest quality)"],
    ...
    },
    {
      ...
      period: "/month",
      credits: 600,
      features: ["600 credits per month", "All operations: 4 credits", "Upscale: 1 credit", "Kontext Max AI model (highest quality)"],
