...
export default function Landing() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <header className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-slate-950 dark:via-purple-950 dark:to-slate-950">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <section className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              ...
              <Button
                size="lg"
                className="border-2 border-purple-400 text-purple-200 hover:bg-purple-600/20 backdrop-blur-sm px-8 py-4 text-lg font-semibold transition-all duration-300"
            ...
            <div className="flex justify-center items-center text-sm text-slate-300 dark:text-slate-400 mb-8">
              <Users className="w-4 h-4 mr-2" />
              Join thousands of creators
            </div>

            {/* Trust Indicators */}
            <div className="flex flex-wrap justify-center items-center gap-8 text-sm text-slate-300 dark:text-slate-400">
          ...
          <section className="max-w-6xl mx-auto mb-16">
            <h2 className="text-4xl font-bold text-center mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-purple-200">
              See the Magic in Action
            </h2>
            <p className="text-center text-slate-300 mb-12">Real transformations powered by AI</p>
              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-purple-500/20 rounded-2xl p-6 shadow-xl hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-300">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="aspect-square bg-gradient-to-br from-gray-600 to-gray-700 rounded-xl flex items-center justify-center border border-slate-600/50 overflow-hidden">
                      <img
                ...
                <p className="text-sm text-slate-400 mt-3 italic font-medium">
